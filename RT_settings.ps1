...
# степень сжатия архивов в зависимости от раздела (от 0 до 9, если не указано - то считается берётся из предыдущей настройки. 0 - без сжатия, 9 - максимальное сжатие)
