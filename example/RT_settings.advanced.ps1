...
# При использовании нескольких клиентов, можно их все перечислить тут. А скрипт будет использовать тот, который передан аргументом.
$client_list = @(
    [ordered]@{
        name     = 'myqbit'
        type     = 'qbittorrent'
