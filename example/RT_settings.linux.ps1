...
$upload_params = @{
    validate = 0             # Проверять ли архив перед загрузкой в гугл.
    cleaner  = 0             # Использовать ли cleaner после архивирования раздачи.
    delete   = 0             # Удалять ли раздачу из клиента, после архивирования.
